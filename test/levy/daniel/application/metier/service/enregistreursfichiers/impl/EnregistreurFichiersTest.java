...
public final class EnregistreurFichiersTest {
	 ...
	 * "Administrateur".
	 */
	public static final String ADMINISTRATEUR 
		= "Administrateur";
	 ...
	 */
	public static final String FICHIER_DOIT_PAS_ETRE_NULL 
		= "fichier ne doit pas être null : ";
	
	/**
	 * "nomFichier doit être null : ".
	 */
	public static final String NOM_FICHIER_DOIT_ETRE_NULL 
		= "nomFichier doit être null : ";
	
	/**
	 * "nomFichier ne doit pas être null : ".
	 */
	public static final String NOM_FICHIER_DOIT_PAS_ETRE_NULL 
		= "nomFichier ne doit pas être null : ";
	
	/**
	 * "Le rapport ne doit pas être vide : ".
	 */
	public static final String RAPPORT_PAS_VIDE 
		= "Le rapport ne doit pas être vide : ";
	
	/**
	 * "Le rapport ne doit pas être null : ".
	 */
	public static final String RAPPORT_PAS_NULL 
		= "Le rapport ne doit pas être null : ";
	...
	public void testEcrireStringDansFileNull() {
		...
		assertNotNull(RAPPORT_PAS_NULL
					, enregistreur.getRapport());
		
		/* vérifie que ecrireStringDansFile(null, ...) 
		 * a retourné un rapport non vide. */
		assertFalse(RAPPORT_PAS_VIDE
