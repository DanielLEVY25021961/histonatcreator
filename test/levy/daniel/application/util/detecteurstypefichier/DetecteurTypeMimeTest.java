...
public final class DetecteurTypeMimeTest {
	...
	/**
	 * "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_GIF : ".
	 */
	public static final String DOIT_RETOURNER_GIF 
		= "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_GIF : ";
	
	/**
	 * "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_BMP : ".
	 */
	public static final String DOIT_RETOURNER_BMP 
		= "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_BMP : ";
	
	/**
	 * "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_XML : ".
	 */
	public static final String DOIT_RETOURNER_XML 
		= "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_XML : ";
	
	/**
	 * "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_TEXT_PLAIN : ".
	 */
	public static final String DOIT_RETOURNER_TEXT_PLAIN 
		= "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_TEXT_PLAIN : ";
	
	/**
	 * "Doit retourner DetecteurTypeMime.MESSAGE_TYPE_MIME_INCONNU : ".
	 */
	...
	public void testGetMIMETypeGIF() {
		...
		assertEquals(DOIT_RETOURNER_GIF
	...
	public void testGetMIMETypeBMP() {
		...
		assertEquals(DOIT_RETOURNER_BMP
	...
	public void testGetMIMETypeTXTISO885915() {
		...
		assertEquals(DOIT_RETOURNER_TEXT_PLAIN
	...
	public void testGetMIMETypeXSD() {
		...
		assertEquals(DOIT_RETOURNER_XML
